...
export const MENU_ITEMS: MenuItem[] = [
  {
    id: 'app-1',
    name: 'Sambuus',
    description: 'Sambuus crispy ah oo ku habboon quraac fudud, qadada dhinaceeda ama waqti kasta oo aad rabto snack, kuna dhex jira hilib jilicsan iyo xawaashyo caraf leh.',
    price: 0.50,
    category: 'appetizer',
    ...
    alt: 'Sambuus Baraa Restaurant',
    tags: ['Cunto Fudud', 'Hilib', 'Crispy', 'Snack'],
    isPopular: true,
    rating: 4.8
  },
  {
    id: 'app-2',
    name: 'Shawaarmo',
    description: 'Shawaarmo lagu diyaariyey hilib jilicsan iyo waxyaabo kale oo la socda. Waa doorasho ku habboon qofka doonaya cunto fudud oo dhadhan fiican leh.',
    price: 2.00,
    category: 'appetizer',
    ...
    alt: 'Shawaarmo Baraa Restaurant',
    tags: ['Fast Food', 'Hilib', 'Macaan'],
    rating: 4.6
  },
  {
    id: 'app-3',
    name: 'Baasto iyo Suugo',
    description: 'Baasto iyo suugo Talyaani-Soomaali ah oo leh dhadhan wanaagsan, lagu diyaariyey suugo yaanyo cusub iyo xawaashyo dabiici ah.',
    price: 1.50,
    category: 'appetizer',
    ...
    alt: 'Baasto iyo suugo Baraa Restaurant',
    tags: ['Pasta', 'Suugo Macaan', 'Dhaqameed'],
    rating: 4.7
  },
  {
    id: 'main-1',
    name: 'Bariis iyo Hilib Ari',
    description: 'Bariis basmati ah oo lala socodsiiyo hilib ari iyo waxyaabo kale oo cuntada dhadhankeeda kor u qaada. Waa doorashada koowaad ee qadada.',
    price: 9.50,
    category: 'main',
    ...
    alt: 'Bariis iyo hilib ari Baraa Restaurant',
    tags: ['Signature', 'Dhaqameed', 'Hilib Ari', 'Basmati'],
    isFeatured: true,
    isPopular: true,
    rating: 4.9
  },
  {
    ...
    description: 'Sabaayad iyo hilib si wanaagsan loo diyaariyey, isku daraya dhadhan hiddaha Soomaaliyeed iyo nafaqo dhab ah.',
    price: 2.00,
    category: 'main',
    ...
    alt: 'Sabaayad iyo hilib Baraa Restaurant',
    tags: ['Sabaayad', 'Hilib', 'Dhaqameed'],
    isPopular: true,
    rating: 4.7
  },
  {
    id: 'main-3',
    name: 'Sabaayad Dhaqameed',
    description: 'Sabaayad dhaqameed jilicsan oo lala siinayo suugo maraq leh oo khudaari ka buuxdo.',
    price: 1.50,
    category: 'main',
    ...
    alt: 'Sabaayad Baraa Restaurant',
    tags: ['Dhaqameed', 'Sabaayad', 'Maraq'],
    rating: 4.8
  },
  {
    id: 'main-4',
    name: 'Qudaar Diyaar ah',
    description: 'Isku-dar miro iyo khudaar kala duwan oo dabiici ah oo la saaray saxan qurux badan (Moos, Kiwi, Canab, Xabxab, Rummaan, Bartaqaan iyo Cambe).',
    price: 3.50,
    category: 'main',
    imageUrl: qudaarDiyaarImg,
    alt: 'Qudaar diyaar ah Baraa Restaurant',
  ...
  },
  {
    ...
    description: 'Pitsa cusub oo aad u macaan oo lagu diyaariyay jiis dhalaalaya (Mozzarella), basbaas, boqoshaada (Mushrooms) iyo waxyaabo kale oo lagu daray.',
    price: 6.50,
    category: 'main',
    imageUrl: pizzaDeluxeImg,
    alt: 'Pizza Deluxe Baraa Restaurant',
  ...
  {
    id: 'drink-1',
    name: 'Casirka Cambaha (Mango)',
    description: 'Casiir dabiici ah oo aad u qabow oo laga soo miiqay cambaha cusub ee dalkeena, iyadoo aan lagu darin wax sonkor macmal ah.',
    price: 2.50,
    category: 'drink',
    ...
    alt: 'Casiirka cambaha Baraa Restaurant',
    tags: ['Qabow', 'Cusub', 'Fruit', 'Mango'],
    isPopular: true,
    rating: 4.7
  },
  {
    ...
    description: 'Coffee loo diyaariyey qaab casri ah oo leh farshaxan qurux badan, espresso laga sameeyay miraha qaxwada ugu fiican iyo caano jilicsan.',
    price: 1.50,
    category: 'drink',
    ...
    alt: 'Coffee Latte Art Baraa Restaurant',
    tags: ['Kuleyl', 'Coffee', 'Latte Art'],
    rating: 4.8
  },
  {
    id: 'dessert-1',
    ...
    alt: 'Tiramisu Special Baraa Restaurant',
  ...
  },
  {
    ...
    alt: 'Macmacaanka Baraa Ice Cream Baraa Restaurant',
